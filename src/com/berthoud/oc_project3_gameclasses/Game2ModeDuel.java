...
public class Game2ModeDuel extends Game2 {
    ...
    public void play() {
        ...
        System.out.println("Prêt à défier Superbrain? \nPour commencer, saisis la combinaison à "
                + partie1.getNbDigits() + " chiffres que Superbrain devra deviner:");
        partie1.setCodeToBeFound( partie1.generateurCode());
        partie2.setCodeToBeFound(partie2.saisieCodeJoueur());
        ...
        while ((!partie1.testAndGetCodeFound()) && (!partie2.testAndGetCodeFound())) {
            ...
            if (partie2.getNbGuesses() == 0) {
                partie2.setCodeProposal( partie2.generateurCode()); //1ere réponse de l'ordinateur = chiffre aléatoire
            }
            ...
            partie2.testAndGetCodeFound();
            partie2.creationPoolCombinaisons();
            if(!partie2.testAndGetCodeFound()) {
        ...
        if ((partie1.testAndGetCodeFound()) && (partie2.testAndGetCodeFound())) {
